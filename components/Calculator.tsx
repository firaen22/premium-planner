...
const Calculator: React.FC = () => {
  ...
  const calculate = (premium: number, curr: Currency, bundle: boolean, prepayYears: 1 | 4): CalculationResult => {
    ...
    const prepaymentInterest = premium * PREPAYMENT_RATE * factor;
        ...
        <div className="lg:col-span-5 space-y-6">
            ...
            <div className="mt-6">
              <label className="flex items-center justify-between cursor-pointer group">
                ...
                <button
                  type="button"
                  className={`${
                    hasBundle ? 'bg-red-600' : 'bg-gray-200'
                ...
                >
                  <span
                    aria-hidden="true"
                    className={`${
                      hasBundle ? 'translate-x-5' : 'translate-x-0'
          ...
          <div className="bg-blue-50 rounded-xl p-5 border border-blue-100">
             <div className="flex items-start mb-4">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-blue-800">預繳保費選項 (4.3% p.a.)</h3>
                </div>
             </div>
             ...
             <div className="grid grid-cols-2 gap-3">
                ...
                >
                  預繳 1 年
                  <span className="block text-xs font-normal opacity-75 mt-1">共繳 2 年保費</span>
                </button>
                <button
                ...
                >
                  預繳 4 年
                  <span className="block text-xs font-normal opacity-75 mt-1">全數繳付 (5年)</span>
                </button>
             </div>
             
             <div className="mt-3 text-xs text-blue-700">
                {prepaymentYears === 1 
                  ? '只需繳付首2年保費。預繳之第2年保費享 4.3% 利息。' 
                  : '一次過繳付全期保費。預繳餘額全數享 4.3% 利息，鎖定高息回報。'}
             </div>
          </div>
